...
<h1><?php _e('Manager Cliparts', $this->textdomain); ?></h1>
<?php echo $notice; ?>
<div class="wrap nbdesigner-container">
			...
			<div class="nbdesigner-content-left postbox">
				<div class="inside">	
					...
					<table class="form-table">
						<tr valign="top">
							<th scope="row" class="titledesc"><?php echo __("Clipart name", $this->textdomain); ?> </th>
							<td class="forminp-text">
								<input type="text" name="nbdesigner_art_name" value="<?php $name = isset($art_data->name) ?  $art_data->name : ''; echo $name; ?>" />						
							</td>
						</tr>				
						<tr valign="top">
							<th scope="row" class="titledesc"><?php echo __("File upload", $this->textdomain); ?> </th>
							<td class="forminp-text">
								<input type="file" name="svg" value="" accept=".svg"/><br />
								<div style="font-size: 11px; font-style: italic;"><?php _e('Allow extensions: svg', $this->textdomain); ?></div>
							</td>
						</tr>				
					</table>
			...
			<div class="nbdesigner-content-side">
				<div class="postbox">
					...
					<div class="inside">
						...
						<p><a id="nbdesigner_add_art_cat"><?php _e('+ Add new art category', $this->textdomain); ?></a></p>
	...
	<div class="clear"></div>
	<div class="postbox">
            <h3><?php echo __('List arts ', $this->textdomain).$name_current_cat; ?><a class="nbdesigner-right" href="<?php echo admin_url('admin.php?page=nbdesigner_manager_arts'); ?>"><?php _e('All arts', $this->textdomain); ?></a></h3>
		<div class="nbdesigner-list-fonts inside">				
                    <div class="nbdesigner-list-arts-container">
                            <?php if(is_array($_list) && (sizeof($_list) > 0)): ?>
                                    ...
                                    <?php endforeach; ?>
                            <?php else: ?>
                                    <?php _e('You don\'t have any art.', $this->textdomain);?>
                            <?php  endif; ?>
                    </div>
                    <div class="tablenav top">
                        <div class="tablenav-pages">
                            <span class="displaying-num"><?php echo $total.' '. __('arts', $this->textdomain); ?></span>
